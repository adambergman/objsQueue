...
// A method with a return value called from Javascript with no paramters
-(NSString *)methodName
{
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Native Alert" message:@"The objsQueue command worked" delegate:self cancelButtonTitle:@"Dismiss" otherButtonTitles:nil, nil];
    [alert show];
    return @"Great job!";
}
